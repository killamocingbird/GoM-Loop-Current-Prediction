...
class Stoch_LBFGS(Optimizer):
    ...
    Arguments:
        ...
        Example usage for full batch mode:
          optimizer = Stoch_LBFGS(model.parameters(), history_size=7, max_iter=100, line_search_fn=True, batch_mode=False)
        Example usage for batch mode (stochastic):
          optimizer = Stoch_LBFGS(net.parameters(), history_size=7, max_iter=4, line_search_fn=True,batch_mode=True)
    ...
    def __init__(self, params, lr=1, max_iter=10, max_eval=None,
        ...
        super(Stoch_LBFGS, self).__init__(params, defaults)
